...
#define PARAM_BOARD_TX_GPIO GPIO_NUM_4
#define PARAM_BOARD_RX_GPIO GPIO_NUM_5
...
#define PARAM_CONNECT_ATTEMPTS 120
...
static int board_connect(param_uart_frame_t *send, param_uart_frame_t *recv)
{
